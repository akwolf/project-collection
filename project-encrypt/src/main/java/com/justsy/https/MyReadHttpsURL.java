...
public class MyReadHttpsURL {         
  ...
  public static void main(String argv[]) throws Exception {         
    ...
    // 受访的页面         
    String url = "/Test/HttpsServlet";         
    // 自定义的管理器         
    X509TrustManager xtm = new MyJava2000TrustManager();         
 ...
 *       
 */        
class MyJava2000TrustManager implements X509TrustManager {         
  MyJava2000TrustManager() {         
    // 这里可以进行证书的初始化操作         
  }         
  // 检查客户端的可信任状态         
